/* File: csveditor.c
 ...
 This is a program that loads CSV (comma separated value) files and analyses them,
 to return various information. Operations, such as deleting adding, merging and
 sorting are also possible with any given .csv file.
